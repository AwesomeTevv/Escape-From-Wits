...
export class CharacterControls {
    ...
    constructor(model: THREE.Group,
        ...
        currentAction: string,
        ray: Ray, rayWall: Ray, rayWallX:Ray, rigidBody: RigidBody) {
        this.model = model
        this.mixer = mixer
    ...
    public update(world: World, delta: number, keysPressed: any) {
        ...
        // let hit = world.castRay(this.rayWall, 0.5, false);
        // if (hit) {
        //     const point = this.rayWall.pointAt(hit.toi);
        ...
        // this.rayWallX.origin.x = translation.x
        // this.rayWallX.origin.y = translation.y
        // this.rayWallX.origin.z = translation.z
        // hit = world.castRay(this.rayWallX, 0.5, false);
        // if (hit) {
        //     const point = this.rayWallX.pointAt(hit.toi);
        //     let diff = translation.x - ( point.x + CONTROLLER_BODY_RADIUS);
        //     if (diff < 0.5) {
